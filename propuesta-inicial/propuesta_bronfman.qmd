---
title: "Logística urbana asimétrica chilena bajo shocks regulatorios"
  ...
  - name: "Gonza [Apellido]"
    affiliations:
      - name: "Doctorado en Ingeniería de Sistemas Avanzados (DISA), Universidad Andrés Bello"
        department: "Mentor inicial: Dr. Hernán Astudillo"
date: today
date-format: "MMMM YYYY"
lang: es
abstract: |
  Propuesta exploratoria de tesis doctoral. Documento preparado para reunión
  con el Dr. Andrés Bronfman, Director Académico del Centro de Transporte y
  Logística (CTL-UNAB).
format:
  pdf:
...
de scientific machine learning (operadores neuronales informados por
física), las cuales permiten evaluar familias paramétricas de soluciones
...
# Por qué esta investigación encaja con CTL / CATLEC

La línea CATLEC explicita su orientación a competitividad logística
...
—no solo un paper—; (iii) las predicciones falsables permiten contrastar
...
## Lo que se solicita en esta etapa {.unnumbered}

**Una reunión exploratoria de aproximadamente 30 minutos**, sin
compromiso de dirección a esta altura. El objetivo es presentar la
motivación del problema, escuchar su lectura sobre la pertinencia y el
encuadre, y evaluar conjuntamente si vale la pena seguir conversando.
Este documento es una versión inicial; espero que su feedback —en
particular sobre el realismo del problema y la disponibilidad de datos
chilenos relevantes— ayude a calibrar la dirección que tome la propuesta
...
\noindent
{\small\itshape\color{softgrey}
Referencias clave consultadas: Aurell, Carmona, Dayanıklı \& Laurière
(SIAM 2022); Carmona \& Wang (2017); Porter (Bell J. Econ. 1983);
Ellison (RAND J. Econ. 1994); Bronfman, Paredes-Belmar, Marianov \&
Eiselt (Springer ISOR/MS 2023).}
